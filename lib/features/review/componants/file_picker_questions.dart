...
class FileQA extends StatefulWidget {
  String name;
  int maxSize;
  late String type = "";
  late String content = "";
  FileQA({required this.name, required this.maxSize});
  @override
  _FileQAState createState() => _FileQAState();
}

class _FileQAState extends State<FileQA> {
      ...
      child: Column(
        children: [
          ...
          Container(
            height: 100.0,
            child:
                method == 'Camera' ? Image.file(imageFile!) : buildGridView(),
          )
        ],
      ),
    );
